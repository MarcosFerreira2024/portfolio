  ...
  return (
    <Link onMouseEnter={()=> setTooltip(true)} onMouseLeave={()=> setTooltip(false)} onClickCapture={()=> setTooltip(false)} href={href} data-tooltip={alt} target="_blank" className={` ${tooltip?"tooltip":""} flex items-center group gap-2 self-start pr-5 animaContato `}>
        <div className='flex items-center gap-2 '>
            <div className={` group-hover:dark:bg-purple-700 min-w-[39px] min-h-[39px] group-hover:bg-title transition-colors w-[39px] h-[39px] group border-purple-700 dark:border-title border-[2px]   rounded-[7.5px] flex items-center justify-center   dark:bg-transparent    ease-linear duration-300`}>
                <Image
