            ...
            <div>
                ...
                <nav className='flex flex-col gap-3   pt-3 '> 
                    <div className='flex   flex-wrap gap-[15px] '>
                        <BotaoMaior href='/Main/Curriculo-Marcos-Vinicius-Ferreira.pdf'  target='_blank' classes='w-[206px] justify-between'  label='Baixar Currículo' src={`/Main/download.svg`} alt='download' />
                    ...
                    <div className='flex '>
                        <BotaoMaior onClick={() => setSobre(!sobre)} classes={`w-[206px] justify-between`} label={sobre ? 'Fechar' : 'Sobre Mim'} src={`/Main/sobre.svg`} alt='perfil' />
         
                    </div>
                    {sobre && <p className='text-left font-title text-md animaTexto max-w-[370px] sm:max-w-full   '>Busco uma oportunidade de <strong className='font-semibold'>Estágio</strong>. Possuo conhecimento em <strong className='font-semibold'>Desenvolvimento Web</strong>, além de experiência prática em criar sites responsivos focados na experiência dos usuários. Atualmente estou estudando <strong className='font-semibold'>Next.js </strong>e <strong className='font-semibold'>Node</strong>. Sou uma pessoa comunicativa, gosto de trabalhar em equipe e priorizo a qualidade e rapidez no desenvolvimento de softwares.</p>}
                </nav>
